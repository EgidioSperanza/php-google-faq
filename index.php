...
$faq = [
    ...
    [
        ...
        'answerDeepening' => [
            'h3' => ['Stabilire il paese associato al tuo account'],
            'p' => [
...
<body>
    ...
    <div class="container">
    <?php foreach ($faq as $request) {
        foreach ($request as $requestSections) {
            foreach ($requestSections as $key => $requestSectionValue) {
                foreach ($requestSectionValue as $value) {
                        echo "<$key>$value</$key>";
                }
            }
        }
